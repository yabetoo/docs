...
const response = await fetch("https://buy.api.yabetoopay.com/v1/checkout/sessions", {
  method: "POST",
  headers: {
...
response = requests.post(
    "https://buy.api.yabetoopay.com/v1/checkout/sessions",
    headers={
        "Authorization": "Bearer sk_live_...",
        "Content-Type": "application/json"
    },
...
curl_setopt_array($curl, [
    CURLOPT_URL => "https://buy.api.yabetoopay.com/v1/checkout/sessions",
...
```json
{
  ...
  "url": "https://pay.yabetoo.com/c/cs_abc123def456ghi789",
  "success_url": "https://votre-site.com/success?session_id={CHECKOUT_SESSION_ID}",
  "cancel_url": "https://votre-site.com/cancel",
  "customer_email": "client@example.com",
  "client_reference_id": "order_12345",
...
const response = await fetch(
  "https://buy.api.yabetoopay.com/v1/checkout/sessions/" + sessionId,
  {
    headers: {
      Authorization: "Bearer sk_live_...",
    },
