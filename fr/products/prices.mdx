...
<ParamField body="currency" type="string" required>
  Code devise, exactement 3 caractères. Stocké et renvoyé en minuscules. **Obligatoire** — il
  n'y a pas de devise par défaut.
</ParamField>
...
`GET /v1/prices/{id}` expose `product` à la racine de l'objet.
