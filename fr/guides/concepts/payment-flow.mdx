...
const confirmedIntent = await yabetoo.paymentIntents.confirm({
...
confirmed_intent = yabetoo.payment_intents.confirm(
...
$confirmedIntent = $yabetoo->paymentIntents->confirm([
  'client_secret' => $paymentIntent->client_secret,
  'first_name' => 'Jean',
  'last_name' => 'Dupont',
  'receipt_email' => 'jean@exemple.com',
...
PaymentIntent confirmedIntent = yabetoo.paymentIntents().confirm(params);
```
...
CheckoutSessionCreateParams params = CheckoutSessionCreateParams.builder()
    ...
    .setSuccessUrl("https://votresite.com/success")
    .setCancelUrl("https://votresite.com/cancel")
    .addItem(item)
    .build();
