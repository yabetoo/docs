...
| Statut | Description |
|--------|-------------|
| `open` | Session créée, en attente du client |
| `complete` | Le client a effectué le paiement |
...
| `PAYER_NOT_FOUND` | Numéro de téléphone invalide | Vérifier le numéro |
...
| `LOW_BALANCE` | Fonds insuffisants | Le client doit recharger |
