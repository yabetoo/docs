...
**Problème :** Le paiement échoue avec l'erreur `PAYER_NOT_FOUND`.
...
**Problème :** Le paiement échoue pour fonds insuffisants.

**Solutions :**
1. Affichez un message clair au client
2. Suggérez-lui de recharger son compte Mobile Money
3. Permettez-lui de réessayer après la recharge
