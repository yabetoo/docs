...
| `46733123455`  | MTN MoMo     | Congo-Brazzaville | `failed` | `PAYEE_NOT_FOUND`               |
...
| `PAYEE_NOT_FOUND`                                   | Le numéro du payeur n'existe pas ou n'est pas enregistré auprès de l'opérateur.            |
