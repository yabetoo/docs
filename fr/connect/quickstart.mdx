...
Ce parcours vous emmène d'un compte vierge à un vendeur payé sur son Mobile Money.
...
<Steps>
  <Step title="Activez Connect et choisissez votre mode">
    Ce choix est **définitif**. Lisez [Commissions](/fr/connect/pricing) avant.
    ...
    <Warning>
    Un `409` signifie « déjà activé », pas une erreur. Le mode est immuable.
    </Warning>
  </Step>
  ...
  <Step title="Envoyez-lui son lien de vérification">
    ...
    Le vendeur y dépose ses pièces **et son numéro Mobile Money de versement**. Sans cette
