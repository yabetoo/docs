...
dossier de vérification, y déposer ses pièces et son numéro Mobile Money de versement.
...
<Steps>
  ...
  <Step title="Il enregistre son numéro Mobile Money">
...
| Statut | Code | Cause |
|---|---|---|
| `401` | — | Vous visez un vendeur `live` avec une clé de test (ou l'inverse) |
| `403` | — | Vendeur inconnu, identifiant malformé, ou vendeur d'une autre marketplace — **la réponse est identique dans les trois cas** |
