...
L'argent d'un vendeur passe par trois états avant d'atteindre son Mobile Money.

```
encaissement → solde en attente → (maturation) → solde disponible → retrait → Mobile Money
```
...
<Warning>
**L'appel est synchrone et attend l'opérateur Mobile Money.** Comptez plusieurs secondes. Le
