...
import com.yabetoo.param.CheckoutSessionCreateParams;
import com.yabetoo.param.CheckoutItem;
...
CheckoutItem item = CheckoutItem.builder()
    ...
    .setProductName("Plan Premium")
    .setQuantity(1)
    .setPrice(5000L)
    .build();

CheckoutSessionCreateParams params = CheckoutSessionCreateParams.builder()
    .setAccountId("acct_xxxxxxxx")
    .setTotal(5000L)
    .setCurrency("xaf")
    .setSuccessUrl("https://votre-site.com/succes")
    .setCancelUrl("https://votre-site.com/annuler")
    .addItem(item)
    .build();

CheckoutSession session = yabetoo.sessions().create(params);

// Redirigez le client vers session.getUrl()
...
PaymentIntentCreateParams createParams = PaymentIntentCreateParams.builder()
    .setAmount(5000L)
    .setCurrency("xaf")
    .setDescription("Abonnement Plan Premium")
    .build();

PaymentIntent intent = yabetoo.paymentIntents().create(createParams);

// Étape 2 : Confirmer avec le moyen de paiement du client
MomoData momoData = MomoData.builder()
    .setCountry("cg")
    .setMsisdn("242123456789")
    .setOperatorName("mtn")
    .build();
...
PaymentIntentConfirmParams confirmParams = PaymentIntentConfirmParams.builder()
    ...
    .setFirstName("Jean")
    .setLastName("Dupont")
    .setReceiptEmail("jean@example.com")
    .setPaymentMethodData(paymentMethodData)
    .build();

PaymentIntent payment = yabetoo.paymentIntents().confirm(confirmParams);
