...
1. [Create and integrate a Checkout Session](/en/payments/checkout-page/create)
2. [Handle payment events](/en/developer-tools/webhook/events)
3. [Test the integration](/en/developer-tools/test/overview)
